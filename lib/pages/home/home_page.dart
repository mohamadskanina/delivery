  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      PersistentBottomNavBarItem(
        ...
        title: ("Home"),
        activeColorPrimary: Color.fromARGB(255, 213, 178, 143),
      ...
      PersistentBottomNavBarItem(
        ...
        title: ("Archive"),
        activeColorPrimary: Color.fromARGB(255, 213, 178, 143),
        inactiveColorPrimary: Color.fromARGB(255, 162, 107, 98),
      ),
      PersistentBottomNavBarItem(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedItemColor: Color.fromARGB(255, 213, 178, 143),
        unselectedItemColor: Color.fromARGB(255, 196, 146, 66),
